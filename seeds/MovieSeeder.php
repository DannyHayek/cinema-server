...
try {
    $queries = [
        ...
        "INSERT INTO movies(name, synopsis, length, age_rating, trailer_link, poster_url) VALUES ('Terminator 2','A cyborg, identical to the one who failed to kill Sarah Connor, must now protect her ten year old son John from an even more advanced and powerful cyborg.', 137, 'R', 'https://www.youtube.com/watch?v=lwSysg9o7wE', '../assets/terminator_2.jpg');", 
